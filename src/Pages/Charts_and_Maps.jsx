...
const Dashboard = () => {
  ...
  // Fetch historical data and initialize chart on component mount
  useEffect(() => {
  ...
  return (
    <div className="w-full pt-20 px-4 pb-8">
      ...
      <div className="border-2 border-blue-500 w-11/12 m-auto 5 auto 5">
        <MapContainer className="m-auto w-full border-blue-700" bounds={[[-60, -180], [85, 180]]} zoom={2} center={[20, 40]} scrollWheelZoom={true}>
          <TileLayer
